...
func main() {
	...
	upgrades := []struct{ table, column, definition string }{
		...
		{"wars", "attacker_damage_pressure", "DECIMAL(9,4) NOT NULL DEFAULT 0"},
		{"wars", "defender_damage_pressure", "DECIMAL(9,4) NOT NULL DEFAULT 0"},
		{"wars", "attacker_infrastructure_damage", "DECIMAL(14,3) NOT NULL DEFAULT 0"},
		{"wars", "defender_infrastructure_damage", "DECIMAL(14,3) NOT NULL DEFAULT 0"},
		{"wars", "attacker_institutions_destroyed", "INT NOT NULL DEFAULT 0"},
		{"wars", "defender_institutions_destroyed", "INT NOT NULL DEFAULT 0"},
		...
		{"war_deployments", "deployment_theater", "ENUM('attacker_homeland','defender_homeland') NOT NULL DEFAULT 'defender_homeland'"},
		{"war_orders", "home_operation", "VARCHAR(40) NOT NULL DEFAULT 'hold'"},
		{"war_orders", "home_posture", "VARCHAR(40) NOT NULL DEFAULT 'entrenched'"},
		{"war_reports", "attacker_foreign_posture", "VARCHAR(40) NOT NULL DEFAULT 'entrenched'"},
		{"war_reports", "defender_foreign_posture", "VARCHAR(40) NOT NULL DEFAULT 'entrenched'"},
		{"war_reports", "attacker_home_operation", "VARCHAR(40) NOT NULL DEFAULT 'hold'"},
		{"war_reports", "attacker_home_posture", "VARCHAR(40) NOT NULL DEFAULT 'entrenched'"},
		{"war_reports", "defender_home_operation", "VARCHAR(40) NOT NULL DEFAULT 'hold'"},
		{"war_reports", "defender_home_posture", "VARCHAR(40) NOT NULL DEFAULT 'entrenched'"},
	}
	...
	bootstrap := []string{
		...
		`DELETE FROM war_deployments WHERE unit_type='drones'`,
