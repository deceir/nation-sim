...
func init() {
	...
	for _, p := range []longTermProject{
		...
		{ID: "advanced_ordnance", Name: "Advanced Munitions & Ordnance Act", Category: "military", Description: "Unlocks advanced military-equipment production.", Cash: 7000000, Turns: 108, Costs: map[string]float64{"construction_materials": 5000, "basic_metals": 4000, "strategic_minerals": 3000}, Unlock: "advanced_ordnance"},
	} {
		add(p)
	}
