...
CREATE TABLE IF NOT EXISTS nations (
  ...
  motto VARCHAR(120) NOT NULL DEFAULT '',
	flag_image LONGBLOB NULL,
	flag_mime VARCHAR(40) NOT NULL DEFAULT '',
	flag_updated_at TIMESTAMP(6) NULL,
  currency_name VARCHAR(30) NOT NULL DEFAULT 'Yen',
  treasury BIGINT NOT NULL DEFAULT 10000000,
  gdp BIGINT NOT NULL DEFAULT 0,
  population BIGINT NOT NULL DEFAULT 10631,
...
CREATE TABLE IF NOT EXISTS wars (
  ...
  attacker_lat DECIMAL(9,6) NULL,
  attacker_lng DECIMAL(9,6) NULL,
  defender_lat DECIMAL(9,6) NULL,
  defender_lng DECIMAL(9,6) NULL,
  mobilization_rounds INT NOT NULL DEFAULT 1,
  supply_factor DECIMAL(7,4) NOT NULL DEFAULT 1,
  attacker_damage_pressure DECIMAL(9,4) NOT NULL DEFAULT 0,
  defender_damage_pressure DECIMAL(9,4) NOT NULL DEFAULT 0,
  attacker_infrastructure_damage DECIMAL(14,3) NOT NULL DEFAULT 0,
  defender_infrastructure_damage DECIMAL(14,3) NOT NULL DEFAULT 0,
  attacker_institutions_destroyed INT NOT NULL DEFAULT 0,
  defender_institutions_destroyed INT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS war_deployments (
  ...
  deployment_theater ENUM('attacker_homeland','defender_homeland') NOT NULL DEFAULT 'defender_homeland',
  created_at TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
...
CREATE TABLE IF NOT EXISTS war_orders (
  ...
  home_operation VARCHAR(40) NOT NULL DEFAULT 'hold',
  home_posture VARCHAR(40) NOT NULL DEFAULT 'entrenched',
...
CREATE TABLE IF NOT EXISTS war_reports (
  ...
  attacker_foreign_posture VARCHAR(40) NOT NULL DEFAULT 'entrenched',
  defender_foreign_posture VARCHAR(40) NOT NULL DEFAULT 'entrenched',
  attacker_home_operation VARCHAR(40) NOT NULL DEFAULT 'hold',
  attacker_home_posture VARCHAR(40) NOT NULL DEFAULT 'entrenched',
  defender_home_operation VARCHAR(40) NOT NULL DEFAULT 'hold',
  defender_home_posture VARCHAR(40) NOT NULL DEFAULT 'entrenched',
